...
public class CRUDActualizar extends JFrame {
	 ...
	 * Create the frame.
	 */
	public CRUDActualizar(JTextField txtUsuario, JTextField txtContrasena, JTextField txtTelefono, ArrayList<Peliculas> crudArray) {
		setTitle("ACTUALIZAR");
		...
		textField_2.setBounds(124, 135, 178, 19);
		...
		textField_4.setBounds(124, 222, 178, 19);
